...
``` 
{
    "events": ["5f85c51996b5601b2406e5b7"],
...
## Post Event
Creates new Event with the first post of the author and returns the event as json.
...
```eventName``` : [string] -- The Title of your new Event, which you want to create
```postText``` : [string] -- The text of your post. This post will be append as first comment on your Event.
...
## Create Post
Creates new Post of the author and returns the event as json.
...
``` 
{
    ...
    "text": "Changed text",
    "userId": "5f86c1f0a112c130e89964af",
    "eventId": "5f85c51996b5601b2406e5b7",
...
.post /events - create new event only for registered users

posts:
.get events/id - get all posts for event
.post events/id - create post in event by id only for registered users
.put events/id/posts/id - edit post only possible for author
.delete events/id/posts/id - delete post only possible for author -->
...
<!--http://localhost:3000/api/events -- {"eventName":"Some Event", "userId":"5f85bf709a517d36f4abe656", "post": "Some Post" } -->
<!-- http://localhost:3000/api/events/5f858dd2d895ad23602db9d4  -- {"userId":"5f8580d25d1da62568dd38fd", "postText": "Some Post textsdfasdf" } -->
